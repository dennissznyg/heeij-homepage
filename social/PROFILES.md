...
| File | Use |
|---|---|
| `profile-1080.png` | Profile picture, all three platforms (circle-safe) |
| `facebook-cover-1640x624.png` | Facebook page cover |
| `linkedin-cover-2256x382.png` | LinkedIn company page cover |

Instagram has no cover. The og-image (`../og-image.png`) doubles as a link-share card.
